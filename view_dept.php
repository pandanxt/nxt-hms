          ...
          ?>
            <div class="card">
              ...
              <h1 class="card-title p-3"><a href="javascript:history.go(-1)"><i class="fas fa-arrow-alt-circle-left"></i>&nbsp;Back</a></h1>
                <?php echo '<h3 class="card-title p-3">'.$row["DEPARTMENT_NAME"].'</h3>'; ?>
              </div><!-- /.card-header -->
              <div class="card-body">
                      ...
                      <div class="col-md-6">
                        <div class="col-md-12 clearfix">
                          ...
                          <?php echo '<div class="row"><label>Options: </label>&nbsp; <p>';
                            echo '<a href="add_service.php?id='.$row["DEPARTMENT_ID"].'"><i class="fas fa-edit"></i></a>';
                            echo '&nbsp; <a href="backend_components/delete_handler.php?serId='.$row["DEPARTMENT_ID"].'" style="color:red;"><i class="fas fa-trash"></i></a>';
                            echo '</p></div>'; 
                          ?>
