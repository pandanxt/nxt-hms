              ...
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <?php
                  if ($type == 'DAILY') {
                    ...
                    ( (SUM(`SLIP_FEE` - `SLIP_DISCOUNT`)*1.0 )* '$docShare')/100 AS `TOTAL_AMOUNT_PAID_TO_DOCTOR`, 
                    ( (SUM(`SLIP_FEE` - `SLIP_DISCOUNT`)*1.0)* '$hosShare')/100 AS `TOTAL_AMOUNT_PAID_TO_CLINIC`, 
                    ( ( (SUM(`SLIP_FEE` - `SLIP_DISCOUNT`)*1.0)* '$hosShare')/100) - ( ( (SUM(`SLIP_FEE` - `SLIP_DISCOUNT`)*1.0)* '$recShare')/100) AS `RECEPTION_SHARE` 
